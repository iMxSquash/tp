        ...
        <header className="header">
            <nav className="nav-container">
                <div className="mobile-header">
                    {auth && <span className="user-greeting">Bienvenue, {auth.prenom}</span>}
                    <button
                ...
                <div className={`nav-content ${isMobileMenuOpen ? 'active' : ''}`}>
                    <div className="nav-left">
                        ...
                        {auth && <Link to="/add" onClick={() => setIsMobileMenuOpen(false)}>Ajouter un article</Link>}
                    </div>
                    ...
                    <div className="nav-right">
                        {auth ? (
                            ...
                            <div className="auth-links">
                                <Link to="/sign" onClick={() => setIsMobileMenuOpen(false)}>Connexion</Link>
